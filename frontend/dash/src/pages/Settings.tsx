...
export const Settings: React.FC = () => {
    const { chatbots, selectedChatbot, setSelectedChatbot } = useChatbot();
                ...
                <div className="col-span-12 md:col-span-9 space-y-12">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                ...
                                <div className="flex gap-4 items-center">
                                    ...
                                    <button className="text-sm text-primary hover:text-primary-fixed transition-colors font-medium shrink-0">Change Password</button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="bots" className="bg-surface-glass backdrop-blur-xl border border-border-subtle rounded-xl p-8 shadow-lg scroll-mt-[96px]">
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <button className="bg-gradient-to-br from-indigo-500 to-violet-500 hover:opacity-90 text-white font-label-sm px-6 py-2.5 rounded-lg transition-all duration-300 shadow-indigo-500/20 shadow-lg flex items-center gap-2">
                                Save Changes
                            </button>
                        </div>
                        ...
                        <div className="flex gap-4 overflow-x-auto pb-6 mb-6 border-b border-border-subtle scrollbar-none">
                            {chatbots.map((bot, idx) => (
                                <div 
                                    ...
                                    <h4 className="font-bold text-text-primary mb-1 truncate">{bot}</h4>
                                    <p className="text-text-muted text-xs">Created Oct 2023</p>
                                </div>
                            ))}

                            <div className="min-w-[240px] border border-border-subtle border-dashed rounded-xl p-5 cursor-pointer transition-all duration-300 hover:bg-surface-glass hover:border-primary/50 flex flex-col items-center justify-center text-text-muted hover:text-primary min-h-[140px]">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex gap-3">
                                            <button className="w-8 h-8 rounded-full bg-[#6366f1] ring-2 ring-white ring-offset-2 ring-offset-bg-base"></button>
                                            <button className="w-8 h-8 rounded-full bg-[#10b981] hover:scale-110 transition-transform"></button>
                                            <button className="w-8 h-8 rounded-full bg-[#f43f5e] hover:scale-110 transition-transform"></button>
                                            <button className="w-8 h-8 rounded-full bg-[#eab308] hover:scale-110 transition-transform"></button>
                                        </div>
                                    </div>
                                </div>
...
<script src="https://cdn.flochat.ai/widget.js" async></script>`}</code>
                            ...
                            <div className="border border-red-500/20 bg-red-500/5 rounded-xl p-6 relative overflow-hidden">
                                ...
                                <div className="flex justify-between items-center flex-wrap gap-4">
                                    ...
                                    <button className="bg-red-500/10 text-red-400 border border-red-500/20 px-4 py-2 rounded-lg font-label-sm text-label-sm hover:bg-red-500/20 transition-all duration-300">
                                        Delete Bot
                                    </button>
                                </div>
                            </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                            <div className="bg-surface-container-low border border-border-subtle rounded-xl p-6">
                                ...
                                <div className="flex items-center justify-between mb-4">
                                    <div>
                                        <p className="font-display-xl text-[24px] text-text-primary tracking-tight">Pro Plan</p>
                                        <p className="text-sm text-text-muted">10,000 Messages / mo</p>
                                    </div>
                                    <div className="text-right">
                                        <p className="font-display-xl text-[24px] text-primary">$49</p>
                            ...
                            <div className="bg-surface-container-low border border-border-subtle rounded-xl p-6 flex flex-col justify-between">
                                <div>
                                    ...
                                    <div className="flex items-center gap-4 mb-4 bg-surface-glass border border-border-subtle p-3 rounded-lg">
                                        <div className="w-10 h-6 bg-surface-container-highest rounded border border-border-subtle flex items-center justify-center text-xs font-bold text-white">VISA</div>
                                        <div>
                                ...
                                <table className="w-full text-left border-collapse">
                                    ...
                                    <tbody className="text-sm">
                                        <tr className="border-b border-border-subtle bg-surface-glass">
                                            <td className="p-4 text-text-primary">Oct 15, 2023</td>
                                            <td className="p-4 text-text-muted">Pro Plan - Monthly</td>
                                            <td className="p-4 text-text-primary">$49.00</td>
                                            <td className="p-4"><span className="px-2 py-1 rounded bg-emerald-500/10 text-emerald-400 text-xs">Paid</span></td>
                                            <td className="p-4 text-right"><button className="text-primary hover:underline">Download</button></td>
                                        </tr>
                                        <tr className="border-b border-border-subtle bg-surface-glass">
                                            <td className="p-4 text-text-primary">Sep 15, 2023</td>
                                            <td className="p-4 text-text-muted">Pro Plan - Monthly</td>
                                            <td className="p-4 text-text-primary">$49.00</td>
                                            <td className="p-4"><span className="px-2 py-1 rounded bg-emerald-500/10 text-emerald-400 text-xs">Paid</span></td>
                                            <td className="p-4 text-right"><button className="text-primary hover:underline">Download</button></td>
                                        ...
                                        <tr className="bg-surface-glass">
                                            <td className="p-4 text-text-primary">Aug 15, 2023</td>
                                            <td className="p-4 text-text-muted">Pro Plan - Monthly</td>
                                            <td className="p-4 text-text-primary">$49.00</td>
                                            <td className="p-4"><span className="px-2 py-1 rounded bg-emerald-500/10 text-emerald-400 text-xs">Paid</span></td>
                                            <td className="p-4 text-right"><button className="text-primary hover:underline">Download</button></td>
