...
export const CurrentIntegrationsTable: React.FC<CurrentIntegrationsTableProps> = ({ integrations }) => {
  return (
              ...
              return (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-right">
                    <button className="p-1.5 rounded-md text-text-muted hover:text-error hover:bg-error/10 transition-colors opacity-0 group-hover:opacity-100 focus:opacity-100 outline-none">
